...
public class FloatingBusTests48
{
    ...
    [Theory]
    [InlineData(14339, 0x00FF, 0x4000, 0xAA)]
    [InlineData(14340, 0x00FF, 0x5800, 0xBB)]
    [InlineData(14341, 0x00FF, 0x4001, 0xCC)]
    [InlineData(14342, 0x00FF, 0x5801, 0xDD)]
    [InlineData(14563, 0x00FF, 0x4100, 0x11)]
    [InlineData(14564, 0x00FF, 0x5800, 0x22)]
    [InlineData(14565, 0x00FF, 0x4101, 0x33)]
    [InlineData(14566, 0x00FF, 0x5801, 0x44)]
    [InlineData(57243, 0x00FF, 0x57FE, 0x45)]
    [InlineData(57244, 0x00FF, 0x5AFE, 0x46)]
    [InlineData(57245, 0x00FF, 0x57FF, 0x47)]
    [InlineData(57246, 0x00FF, 0x5AFF, 0x48)]
    ...
    [Theory]
    [InlineData(14343, 0x00FF, 0x4000, 0xAA)]
    [InlineData(14344, 0x00FF, 0x5800, 0xBB)]
    [InlineData(14345, 0x00FF, 0x4001, 0xCC)]
    [InlineData(14346, 0x00FF, 0x5801, 0xDD)]
    [InlineData(14567, 0x00FF, 0x4100, 0x11)]
    [InlineData(14568, 0x00FF, 0x5800, 0x22)]
    [InlineData(14569, 0x00FF, 0x4101, 0x33)]
    [InlineData(14570, 0x00FF, 0x5801, 0x44)]
