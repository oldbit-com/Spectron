...
public class FloatingBusTests48
{
    ...
    [InlineData(57244, 0x00FF, 0x57FE, 0x45)]
    [InlineData(57245, 0x00FF, 0x5AFE, 0x46)]
    [InlineData(57246, 0x00FF, 0x57FF, 0x47)]
    [InlineData(57247, 0x00FF, 0x5AFF, 0x48)]
    ...
    [Theory]
    [InlineData(14344, 0x00FF, 0x4000, 0xAA)]
    [InlineData(14345, 0x00FF, 0x5800, 0xBB)]
    [InlineData(14346, 0x00FF, 0x4001, 0xCC)]
    [InlineData(14347, 0x00FF, 0x5801, 0xDD)]
    [InlineData(14568, 0x00FF, 0x4100, 0x11)]
    [InlineData(14569, 0x00FF, 0x5800, 0x22)]
    [InlineData(14570, 0x00FF, 0x4101, 0x33)]
    [InlineData(14571, 0x00FF, 0x5801, 0x44)]
