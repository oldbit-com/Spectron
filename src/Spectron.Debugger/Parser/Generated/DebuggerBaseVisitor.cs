...
public partial class DebuggerBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IDebuggerVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitGotostmt([NotNull] DebuggerParser.GotostmtContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitSavestmt([NotNull] DebuggerParser.SavestmtContext context) { return VisitChildren(context); }
	/// <summary>
