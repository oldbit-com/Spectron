...
internal static class Register
{
    ...
    internal const int FineTuneB = 2;
    internal const int CoarseTuneB = 3;
    internal const int FineTuneC = 4;
    internal const int CoarseTuneC = 5;
    internal const int NoisePeriod = 6;
    internal const int Mixer = 7;
